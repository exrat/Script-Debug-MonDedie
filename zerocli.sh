...
server="https://www.ratbox.nl/paste/"
me=$(basename $0)
path=$(dirname $0)
workingdir=""
config=""
...
function post() {
	...
	echo -e "Allez sur le topic adéquat et postez ce lien:\n${CYELLOW}$server?$id#$key${CEND}"
	echo -e "\nFichier stocké en: ${CYELLOW}/tmp/rapport.txt${CEND}"
